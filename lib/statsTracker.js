 ...
 */
export async function recordInteraction(userId, stats, userMessage, responseMessage, responseTime = 0, detectedTopics = [], responseType = null) {
  // Update basic stats
  ...
  if (responseType) {
    stats.responseTypes = stats.responseTypes || { response: 0, code: 0, terminalCommand: 0 };
